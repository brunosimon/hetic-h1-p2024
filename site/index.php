...
<head>
    <meta charset="UTF-8">
    <title>Développement Web - H1 P2024 - Bruno Simon</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">H1 P2024 - Dév<span class="hidden-xs">eloppement</span> Web</a>
            <ul class="nav navbar-nav navbar-right">
                <li><a class="btn btn-light" href="https://github.com/brunosimon/hetic-h1-p2024" target="_blank">GitHub</a></li>
            </ul>
        </div>
    </nav>
